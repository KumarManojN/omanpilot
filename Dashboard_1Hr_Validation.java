...
public class Dashboard_1Hr_Validation 
{
	WebDriver driver;
	  @BeforeMethod
	  ...
	  {
			/*
			 * WebElement select_date_1HR=driver.findElement(By.
			 * xpath("//button[@id='one_hr' and text()='1 Hr']")); Actions act=new
			 * Actions(driver); act.moveToElement(select_date_1HR); select_date_1HR.click();
			 * Thread.sleep(3000);
			 */
	  ...
	  public void tank1_ph_Test() throws InterruptedException
	  {
	        ...
	        Thread.sleep(20000);
	        boolean phChart=driver.findElement(By.xpath("//canvas[@id='chart']")).isDisplayed();
	        if(phChart)
	        {
	        	System.out.println("chart for ph is displayed");
	        }
	        else
	        {
	        	System.out.println("chart is not displayed for ph");
	        }
	  }
	        ...
	        {
				/*
				 * WebElement select_date_1HR_TDS=driver.findElement(By.
				 * xpath("//button[@id='one_hr' and text()='1 Hr']")); Actions act2=new
				 * Actions(driver); act2.moveToElement(select_date_1HR_TDS);
				 * select_date_1HR_TDS.click(); Thread.sleep(3000);
				 */
	       ...
	       // act2.moveToElement(seawater_Tank1_Tds);
	        ...
	        public void tank1_Ec_Test() throws InterruptedException
	        {
				 ...
				 * WebElement select_date_1HR=driver.findElement(By.
				 * xpath("//button[@id='one_hr' and text()='1 Hr']")); Actions act2=new
				 * Actions(driver); act2.moveToElement(select_date_1HR);
				 * select_date_1HR.click();
				 */
	        ...
	        public void tank2_Chart_Test() throws InterruptedException
	        {
				 ...
				 * xpath("//button[@id='one_hr' and text()='1 Hr']")); Actions act2=new
				 * Actions(driver); act2.moveToElement(select_date_1HR);
				 * select_date_1HR.click(); Thread.sleep(3000);
				 */
