...
public class Dashboard_MonthStart_Vlidation {
	WebDriver driver;
	  @BeforeMethod
	  public void SetUp() throws InterruptedException
	  {
		  System.setProperty("webdriver.chrome.driver","C:\\selenium drivers\\chromedriver_win32\\chromedriver.exe");
	       ...
	       @Test(priority=1)
	        ...
	        tank1Chart.click();
	        Thread.sleep(2000);
	        WebElement select_date_MonthStart_PH=driver.findElement(By.xpath("//button[text()='Month Start ']"));
	        Actions act=new Actions(driver);
	        act.moveToElement(select_date_MonthStart_PH);
	        select_date_MonthStart_PH.click();
	        Thread.sleep(10000);
...
Thread.sleep(2000);
WebElement select_date_MonthStart_TDS=driver.findElement(By.xpath("//button[text()='Month Start ']"));
Actions act2=new Actions(driver);
act2.moveToElement(select_date_MonthStart_TDS);
select_date_MonthStart_TDS.click();
Thread.sleep(10000);
...
public void tank1_Ec_Test() throws InterruptedException
{
     ...
     Thread.sleep(2000);
     WebElement select_date_MonthStart_EC=driver.findElement(By.xpath("//button[text()='Month Start ']"));
     Actions act2=new Actions(driver);
     act2.moveToElement(select_date_MonthStart_EC);
     select_date_MonthStart_EC.click();
     Thread.sleep(10000);
     ...
     public void tank2_Chart_Test() throws InterruptedException
     {
          ...
          WebElement select_date_MonthStart_Ph=driver.findElement(By.xpath("//button[text()='Month Start ']"));
	       Actions act2=new Actions(driver);
	       act2.moveToElement(select_date_MonthStart_Ph);
	       select_date_MonthStart_Ph.click();
         Thread.sleep(10000);
    ...
    else
    {
       ...
       Thread.sleep(2000);
		  ...
		  WebElement select_date_1Day_Ec=driver.findElement(By.xpath("//button[text()='Month Start ']"));
Actions act2=new Actions(driver);
...
Thread.sleep(10000);
     ...
     else
     {
      ...
      tdsTank1.click();
      Thread.sleep(2000);
      WebElement select_date_MontStart_TDS=driver.findElement(By.xpath("//button[text()='Month Start ']"));
      Actions act2=new Actions(driver);
      act2.moveToElement(select_date_MontStart_TDS);
      select_date_MontStart_TDS.click();
      Thread.sleep(10000);	
