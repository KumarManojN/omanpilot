...
public class Dashboard_8Hrs_Validation 
{
	WebDriver driver;
	  @BeforeMethod
	  ...
	  public void tank1_Chart_Test() throws InterruptedException
	  {
	      ...
	      tank1Chart.click();
        Thread.sleep(2000);
        WebElement select_date_8HR=driver.findElement(By.xpath("//button[text()='8 Hrs']"));
	      Actions act=new Actions(driver);
	      act.moveToElement(select_date_8HR);
	      select_date_8HR.click();
	      Thread.sleep(10000);
...
act2.moveToElement(select_date_8HR);
select_date_8HR.click();
	...
	public void seaWater_Tank2_ph_Test() throws InterruptedException
	{
		...
		@Test(priority=8)
		public void seaWatertds_Tank2_Test() throws InterruptedException
		{
