...
public class Dashboard_Past_7Dyas_Validation {
	WebDriver driver;
	  @BeforeMethod
	  public void SetUp() throws InterruptedException
	  {
		  System.setProperty("webdriver.chrome.driver","C:\\selenium drivers\\chromedriver_win32\\chromedriver.exe");
			...
			driver.get("http://localhost:4200/default/dashboard");
	  ...
	  public void tank1_Chart_Test() throws InterruptedException
	  {
	      ...
	      tank1Chart.click();
        Thread.sleep(2000);
        WebElement select_date_7Days_PH=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
	      Actions act=new Actions(driver);
	      act.moveToElement(select_date_7Days_PH);
	      select_date_7Days_PH.click();
	      Thread.sleep(10000);
  ...
  act2.moveToElement(seawater_Tank1_Tds);
  seawater_Tank1_Tds.click();
  Thread.sleep(2000);
  WebElement select_date_7Days_tds=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
  Actions act=new Actions(driver);
  act.moveToElement(select_date_7Days_tds);
  select_date_7Days_tds.click();
  Thread.sleep(10000);
  ...
  public void tank1_Ec_Test() throws InterruptedException
  {
       ...
       Actions act1=new Actions(driver);
       act1.moveToElement(seawaterTank1Ec);
       seawaterTank1Ec.click();
       Thread.sleep(2000);

		  WebElement select_date_7Days_ec=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
	      Actions act=new Actions(driver);
	      act.moveToElement(select_date_7Days_ec);
	      select_date_7Days_ec.click();
	      Thread.sleep(10000);
   ...
   public void tank2_Chart_Test() throws InterruptedException
   {
        ...
        tank2Chart.click();
        Thread.sleep(2000);
        WebElement select_date_7Days=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
	      Actions act=new Actions(driver);
	      act.moveToElement(select_date_7Days);
	      select_date_7Days.click();
	      Thread.sleep(10000);
	...
	public void seaWater_Tank2_Ph_Test() throws InterruptedException
	{
      ...
      else
      {
		...
		public void  seaWater_Tank2_Ec_Test() throws InterruptedException
		{
         ...
         WebElement select_date_7Days=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
	      Actions act1=new Actions(driver);
	      act1.moveToElement(select_date_7Days);
	      select_date_7Days.click();
	      Thread.sleep(12000);
		...
		@Test(priority=9)
		public void tank1_Ph_Leg1_Test() throws InterruptedException
		{  
		...
		@Test(priority=10)
		public void tank2_TDS_Leg1_Test() throws InterruptedException
		{
			
        WebElement tdsTank1=driver.findElement(By.xpath("//div[@id='leg2_t1_tds_card']"));
        Actions act1=new Actions(driver);
        act1.moveToElement(tdsTank1);
        tdsTank1.click();
        Thread.sleep(2000);
        WebElement select_date_7Days=driver.findElement(By.xpath("//button[text()='Past 7 Days']"));
	      Actions act=new Actions(driver);
      ...
      boolean phChartTank3=driver.findElement(By.xpath("//canvas[@id='chart']")).isDisplayed();
		...
		@Test(priority=34)
		public void water_To_Drain_Chart() throws InterruptedException
		{
			
        WebElement waterflowtodrainChart=driver.findElement(By.xpath("//div[@id='tank3_drain_card']"));
        Actions act1=new Actions(driver);
        act1.moveToElement(waterflowtodrainChart);
       ...
       public void water_To_Farm() throws InterruptedException
       {
      	 
           WebElement watertofarmChart=driver.findElement(By.xpath("//div[@id='tank3_farm_card']"));
           Actions act1=new Actions(driver);
           act1.moveToElement(watertofarmChart);
