...
public class AquaF_Leg2_Charecter_Validation 
{
	WebDriver driver;
	String ExpectedMsg="Saved Data Successfully..";
	  ...
	  public void loginToApp() throws InterruptedException
	  {
		 ...
		 password.click(); password.sendKeys("test@123"); 
		  ...
		  submit.click();
		  Thread.sleep(3000);
		 WebElement leg2click=driver.findElement(By.xpath("//a[text()='Desalinated Water ']"));
		 leg2click.click();
		 Thread.sleep(2000);
		 Alert alt=driver.switchTo().alert();
		 Thread.sleep(2000);
        ...
        public void Water_flow_to_T2_Test() throws InterruptedException 
  {
       ...
       public void Delay_Between_Pumping_Minute_Test() throws InterruptedException
       {
    	   loginToApp();
    		  SoftAssert assertion=new SoftAssert();
    	  		...
    	  		Thread.sleep(3000);
    	  		delaybetweenpumpingvalue.sendKeys("200e");
    	  		Thread.sleep(2000);
    	  		Actions act=new Actions(driver);
    	  		act.sendKeys(Keys.ENTER).perform();
    	  		WebElement savechanges=driver.findElement(By.xpath("(//button[text()='Save Changes'])[2]"));
       ...
       public void Delay_Between_Pumping_Second_Test() throws InterruptedException
       {
    	   loginToApp();
    	   SoftAssert assertion=new SoftAssert();
     		WebElement delaybetweenpumpingvalueseconds=driver.findElement(By.xpath("(//input[@class='form-control'])[4]"));
     		...
     		Actions act=new Actions(driver);
     		act.sendKeys(Keys.ENTER).perform();
     		WebElement savechanges=driver.findElement(By.xpath("//button[@id='t1_save']"));
     	  		savechanges.click();
     	  		Thread.sleep(2000);
      ...
      public void click_On_Save_Tank1_Test() throws InterruptedException
      {
       ...
       public void Delay_between_pumping_Minute_Tank2_Test() throws InterruptedException
       {
	     ...
	     WebElement delaybetweenpumpingmin=driver.findElement(By.xpath("(//input[@class='form-control'])[12]"));
		   ...
		   Thread.sleep(2000);
		     delaybetweenpumpingmin.sendKeys("34e");
        ...
        public void delay_between_pumping_Second_Tank2_Test() throws InterruptedException
        {
		   ...
		   System.out.println("delay between pumping minimum  values are cleared");
		     Thread.sleep(2000);
		     delaybetweenpumpingsec.sendKeys("45e");
    ...
    waterflowreverse.sendKeys("453e");
    ...
    delaywaterpumpingt2min.sendKeys("20e");
    ...
    delaybetweenpumpingt2sec.sendKeys("100e");
