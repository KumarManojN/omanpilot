...
public class Dashboard_4Hrs_Validation 
{
	WebDriver driver;
	  @BeforeMethod
	  ...
	  public void tank1_Chart_Test() throws InterruptedException
	  {
	      ...
	      tank1Chart.click();
        Thread.sleep(3000);
        WebElement select_date_4HR_PH=driver.findElement(By.xpath("//button[text()='4 Hrs']"));
	      Actions act=new Actions(driver);
	      act.moveToElement(select_date_4HR_PH);
	      select_date_4HR_PH.click();
	      Thread.sleep(15000);
 ...
 //   act2.moveToElement(seawater_Tank1_Tds);
    ...
    Thread.sleep(3000);
    WebElement select_date_4HR_TDS=driver.findElement(By.xpath("//button[text()='4 Hrs']"));
	  Actions act2=new Actions(driver);
    act2.moveToElement(select_date_4HR_TDS);
    select_date_4HR_TDS.click();
     Thread.sleep(15000);
    ...
    public void tank1_Ec_Test() throws InterruptedException
    {
         ...
         Thread.sleep(3000);
         WebElement select_date_4HR_EC=driver.findElement(By.xpath("//button[text()='4 Hrs']"));
         Actions act2=new Actions(driver);
         act2.moveToElement(select_date_4HR_EC);
         select_date_4HR_EC.click();
         Thread.sleep(15000);
     ...
     public void tank2_Chart_Test() throws InterruptedException
     {
          ...
          WebElement select_date_4HR_Ph=driver.findElement(By.xpath("//button[text()='4 Hrs']"));
          Actions act2=new Actions(driver);
          act2.moveToElement(select_date_4HR_Ph);
          select_date_4HR_Ph.click();
          Thread.sleep(15000);
	...
	public void seaWater_Tank2_ph_Test() throws InterruptedException
	{
      ...
      Thread.sleep(12000);	
		...
		@Test(priority=17)
		public void leg3_tank1_Chart() throws InterruptedException
		{
		...
		@Test(priority=18)
		public void ph_Tank1_Leg3() throws InterruptedException
		{
