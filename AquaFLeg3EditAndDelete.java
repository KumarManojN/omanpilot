...
public class AquaFLeg3EditAndDelete 
{
	WebDriver driver;
...

	{
		...
		//DELAY BETWEEN PUMPING
	     ...
	     else
	     {
			...
			Thread.sleep(3000);
			delaybetweenpumpingvalue.sendKeys("12");
			Thread.sleep(2000);
			...
			System.out.println("delay between pumping value  value are cleared");
			Thread.sleep(3000);
			dealaybetweenpumpingvalueseconds.sendKeys("12");
			Thread.sleep(2000);
		     ...
		     Thread.sleep(2000);
		      ...
		      WebElement waterflowtot3=driver.findElement(By.xpath("//input[@id='t2_t3_wflow']"));
			     ...
			     act3.moveToElement(delaybetweenpumpingmin);
				   ...
				   Thread.sleep(2000);
				     delaybetweenpumpingmin.sendKeys("12");
				     Thread.sleep(3000);
				   ...
				   System.out.println("delay between pumping minimum  values are cleared");
				     Thread.sleep(2000);
				     delaybetweenpumpingsec.sendKeys("12");
				     Thread.sleep(3000);
	              ...
	              else
	              {
				     ...
				     else
				     {
				      ...
				      delaywaterpumpingt2min.sendKeys("12");
				      Thread.sleep(3000);
			          ...
			          delaybetweenpumpingt2sec.sendKeys("12");
			          Thread.sleep(3000);
